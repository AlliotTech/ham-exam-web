...
const REMOTE_BASE =
  process.env.DATASET_REMOTE ||
  "https://raw.githubusercontent.com/AlliotTech/crac-amateur-radio-exam-questions-2025-csv/main";
...
async function build() {
  ...
  await Promise.all([processBank("A"), processBank("B"), processBank("C"), processBank("full")]);
